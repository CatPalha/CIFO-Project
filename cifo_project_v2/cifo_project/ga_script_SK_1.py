...
params1 = {
        ...
        "Selection-Approach"        : RouletteWheelSelection(),
        "Tournament-Size"           : 5,
        "Crossover-Approach"        : n_point_crossover,
        "Mutation-Aproach"          : single_point_mutation,
        "Replacement-Approach"      : elitism_replacement
    }
...
params2 = {
        ...
        "Selection-Approach"        : RouletteWheelSelection(),
        "Tournament-Size"           : 1,
        "Crossover-Approach"        : uniform_crossover,
        "Mutation-Aproach"          : single_point_mutation,
        "Replacement-Approach"      : elitism_replacement
    }
"""
...
sa_init_params1 = {
    ...
    "Update-Rate" : 0.9,
    "Initialize-Method-C" : "Fitness Dependent",
    "Initialize-Method-Minimum-C" : "Classical",
    "Neighborhood-Size" : 5,
    "Neighborhood-Function": tsp_bitflip_get_neighbors
}
...
print("PIP crossover approach = single point:", df0["Fitness_Mean"].loc[df0["Generation"] == 500])
print("PIP crossover approach = n point:", df1["Fitness_Mean"].loc[df1["Generation"] == 500])
print("PIP crossover approach = uniform:", df2["Fitness_Mean"].loc[df2["Generation"] == 500])
"""
...
print("Tabu search maximum iterations = 450:", df7["Fitness_Mean"].loc[df7["Generation"] == 0])
print("Tabu search maximum iterations = 500:", df8["Fitness_Mean"].loc[df8["Generation"] == 0])
